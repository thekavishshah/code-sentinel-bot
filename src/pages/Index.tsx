...
const Index = () => {
  ...
  const defaultMockPRs = [
    {
      ...
      deletions: 67,
      changedFiles: [
        { name: 'src/components/auth/jwt.js', additions: 80, deletions: 10 },
        { name: 'src/services/authService.js', additions: 120, deletions: 25 },
        { name: 'src/controllers/authController.js', additions: 45, deletions: 32 },
      ],
      testCoverageDetails: [
        { file: 'src/services/authService.js', coverage: '75%', status: 'decreased' },
        { file: 'src/controllers/authController.js', coverage: '90%', status: 'increased' },
      ],
      riskScore: 75,
      checks: {
        conflicts: false,
    ...
    },
    {
      ...
      deletions: 23,
      changedFiles: [
        { name: 'src/components/dashboard/styles.css', additions: 40, deletions: 10 },
        { name: 'src/components/dashboard/index.js', additions: 49, deletions: 13 },
      ],
      testCoverageDetails: [
        { file: 'src/components/dashboard/index.js', coverage: '95%', status: 'increased' },
      ],
      riskScore: 25,
      checks: {
        conflicts: false,
    ...
    },
    {
      ...
      deletions: 203,
      changedFiles: [
        { name: 'src/db/connection.js', additions: 10, deletions: 150 },
        { name: 'src/models/User.js', additions: 20, deletions: 20 },
        { name: 'src/utils/pool.js', additions: 126, deletions: 33 },
      ],
      testCoverageDetails: [
        { file: 'src/db/connection.js', coverage: '30%', status: 'decreased' },
        { file: 'src/utils/pool.js', coverage: '50%', status: 'decreased' },
      ],
      riskScore: 95,
      checks: {
        conflicts: true,
      ...
      conflictDetails: [
        {
          ...
          base_branch: 'main',
          head_branch: 'feature/db-refactor',
  ...
  return (
    <div className="min-h-screen bg-black relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-purple-950/90 via-black/80 to-purple-950/90"></div>
      <div className="absolute top-0 right-0 w-96 h-96 bg-gradient-to-bl from-purple-950/40 to-transparent rounded-full blur-3xl opacity-25 animate-blob-1"></div>
      <div className="absolute bottom-0 left-0 w-80 h-80 bg-gradient-to-tr from-purple-950/50 to-transparent rounded-full blur-3xl opacity-30 animate-blob-2"></div>
      <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-96 bg-gradient-to-r from-purple-900/30 to-purple-950/40 rounded-full blur-3xl opacity-20 animate-blob-3"></div>
      <div className="absolute top-1/4 right-1/4 w-64 h-64 bg-gradient-to-br from-purple-900/25 to-transparent rounded-full blur-2xl opacity-15 animate-blob-2 animation-delay-4000"></div>
      <div className="absolute bottom-1/4 left-1/4 w-72 h-72 bg-gradient-to-tl from-purple-900/30 to-transparent rounded-full blur-2xl opacity-12 animate-blob-1 animation-delay-2000"></div>
      
      {/* Content container */}
      <div className="relative z-10">
        {/* Header */}
        <div className="border-b border-white/20 backdrop-blur-sm sticky top-0 z-50">
          <div className="max-w-7xl mx-auto px-6 py-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h1 className="text-2xl font-bold text-white">Code Sentinel</h1>
                  <p className="text-sm text-gray-300">Intelligent Pull Request Analysis</p>
                </div>
              </div>
                ...
                <Card>
                  ...
                  <CardContent>
                    <div className="grid grid-cols-3 gap-6 mb-6">
                      ...
                      <div className="text-center">
                        <div className="text-lg font-semibold">{currentPR.filesChanged}</div>
